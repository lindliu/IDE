...
def hyper_min_1(func, func_m, batch_t, inter_t, batch_y, method, init, range_, max_evals=100, need_inter=True):
    ...
    init_vals = [{'sigma':init[0], 'mu':init[1], 'beta':init[2], 'gamma':init[3], 'S0':init[4], 'tau':init[5]}]
