...
for idx in range(6):
        ...
        path_peak_1 = glob.glob(f'../figures_trend_/{filename}_{start_1}_*_first_peak/*.npz')[0]
        ...
        path_peak_2 = glob.glob(f'../figures_trend_/{filename}_{start_2}_*_second_peak/*.npz')[0]
