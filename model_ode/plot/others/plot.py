...
path, data, _, time_day, N, file_name = \
    load_result_path(country, start, estimate, prop, length, case='simulation_2_0')
data_train = data['I']

weeks = 4
pred_length = 7*weeks
pred_1, pred_2 = 2, 7
peaks = [59, 182, 325] ### three peaks of the synthetic data
...
fig.tight_layout()
fig.savefig(f'prediction_synthetic_diff.png', bbox_inches='tight', dpi=300)
