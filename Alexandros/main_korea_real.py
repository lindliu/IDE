...
if __name__ == '__main__':
    ...
    dis = 3
    # for num in range(308,350,dis):
    for num in [106, 108, 109, 111, 112, 114, 115, 117, 118, 120, 121, 123, 124, 126, 127, 129, 130,132, 133,
        ...
        for kk in range(35):
            ...
            for itr in range(epoch_sub):
                ...
                if itr%100==0:
                    ...
                    # if loss<1e+7: ###real south africa and real mexico
                    if loss<3e+7: ###real south korea
                        flag = True
                        break
                    try:
